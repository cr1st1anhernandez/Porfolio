...
export const Typescript01Icon = (props: React.SVGProps<SVGSVGElement>) => (
	<svg
		xmlns="http://www.w3.org/2000/svg"
		viewBox="0 0 24 24"
		width={48}
		...
		/>
		<path
			d="M18 12H16.2C15.5373 12 15 12.5373 15 13.2V13.8C15 14.4627 15.5373 15 16.2 15H16.8C17.4627 15 18 15.5373 18 16.2V16.8C18 17.4627 17.4627 18 16.8 18H15"
			stroke="currentColor"
			strokeWidth="1.5"
			strokeLinecap="round"
			strokeLinejoin="round"
		/>
		<path
			d="M8.5 12H10.5M12.5 12H10.5M10.5 12V18"
			stroke="currentColor"
			strokeWidth="1.5"
			strokeLinecap="round"
			strokeLinejoin="round"
...
export const GitMergeIcon = (props: React.SVGProps<SVGSVGElement>) => (
	<svg
		...
		/>
		<path
			d="M7.02165 8.27881V15.4068M14.4117 12.0043L10.0198 12.0043C8.92206 12.0043 6.86231 11.1249 7.01867 8.77952"
			stroke="currentColor"
			strokeWidth="1.5"
			strokeLinecap="round"
			strokeLinejoin="round"
...
export const JavaIcon = (props: React.SVGProps<SVGSVGElement>) => (
	<svg
		...
		{...props}>
		<path
			d="M6.17481 10.3331C4.96738 10.7407 4.22049 11.3039 4.22049 11.926C4.22049 12.7742 5.60897 13.5129 7.6601 13.8968M7.6601 13.8968C6.89833 14.2823 6.44271 14.7714 6.44271 15.3037C6.44271 16.5473 8.93001 17.5554 11.9983 17.5554C12.7884 17.5554 13.54 17.4886 14.2205 17.3681M7.6601 13.8968C8.61629 14.0758 9.71648 14.1778 10.8872 14.1778C12.5946 14.1778 14.1521 13.9609 15.3316 13.6044M16.4427 10.1242C15.031 10.5413 13.0635 10.8001 10.8872 10.8001C6.5916 10.8001 3.10938 9.7919 3.10938 8.54827C3.10938 7.58798 5.18563 6.76809 8.10937 6.44434"
			stroke="currentColor"
			strokeWidth="1.5"
			strokeLinecap="round"
			strokeLinejoin="round"
...
export const SpringBootIcon = (props: React.SVGProps<SVGSVGElement>) => (
	<svg viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg" width={48} height={48} {...props}>
		<path
...
export const ProgrammingFlagIcon = (props: React.SVGProps<SVGSVGElement>) => (
	<svg
		xmlns="http://www.w3.org/2000/svg"
		viewBox="0 0 24 24"
		width={48}
